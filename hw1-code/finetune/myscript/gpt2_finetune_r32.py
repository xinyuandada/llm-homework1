...
lora_config = LoraConfig(
    ...
    lora_alpha=64, # a scaling factor that adjusts the magnitude of the weight matrix. Usually set to 1
...
working_dir = './'
output_directory = os.path.join(working_dir, "gpt2-alpaca-outputs-5_28-32")
